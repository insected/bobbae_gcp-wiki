[Tensor Processing Units (TPUs)](https://cloud.google.com/tpu/docs/tpus) are Google’s custom-developed application-specific integrated circuits (ASICs) used to accelerate machine learning workloads. 
