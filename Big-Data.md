...
[Dataproc]( Dataproc  ) is a fully managed and highly scalable service for running [Apache Hadoop](  Hadoop ), [Apache Spark](Spark), Apache Flink, Presto, and [a long list of  open source tools and frameworks]( https://en.m.wikipedia.org/wiki/List_of_Apache_Software_Foundation_projects 
) .
