...
Using [Workload Identity Federation](Workload-Identity-Federation), you can grant on-premises or multi-cloud workloads access to Google Cloud resources, without using a service account key.
