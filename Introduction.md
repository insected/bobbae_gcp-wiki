...
[Google Cloud Platform](https://cloud.google.com/) offers four main kinds of [products](https://cloud.google.com/products) and [services](  https://gcp.solutions/ ): [Compute](Compute), [Storage](Storage), [Big Data](Big-Data), [AI Platform](AIhFlatform) and [Machine Learning](Machine-Learning). 
